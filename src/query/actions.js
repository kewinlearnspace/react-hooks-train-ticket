...
export function toggleOrderType() {
  return (dispatch, getState) => {
    ...
    orderType === ORDER_DEPART
      ? dispatch({ type: ACTION_SET_ORDER_TYPE, payload: ORDER_DURATION })
      : dispatch({ type: ACTION_SET_ORDER_TYPE, payload: ORDER_DEPART })
  }
}
export function toggleOnlyTickets() {
  return (dispatch, getState) => {
    const { onlyTickets } = getState()
    dispatch({ type: ACTION_SET_ONLY_TICKETS, payload: !onlyTickets })
  }
}
...
export function setCheckdTicketTypes(checkdTicketTypes) {
  return {
    type: ACTION_SET_CHECKED_TICKET_TYPES,
    payload: checkdTicketTypes,
  }
}
...
export function toggleIsFiltersVisible() {
  return (dispatch, getState) => {
    ...
    dispatch({ type: ACTION_SET_IS_FILTERS_VISIBLE, payload: !isFiltersVisible })
  }
}
